...
/**
 * Stores, whether 'Maybe' is allowed as the decision for a review or not.
 ...
 *
 * The default state is active, so if no preference is changed, the 'Mabye' option is enabled.
 */
