...
<div class="flex flex-row justify-between bg-red-200 h-fit w-full gap-4">
    <PaperNavigationBar {user} backRef="/" paper={data.paper} />
    <div class="bg-amber-400">
        <div class="w-8 h-8 bg-slate-400">BB</div>
    </div>
</div>
