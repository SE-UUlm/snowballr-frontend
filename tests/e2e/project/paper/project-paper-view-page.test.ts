...
test.describe("Decide on Paper Tests", () => {
    test.fixme("When the user decides on a paper by clicking the corresponding decision button, then a review is submitted and the next paper to review is opened", async ({
        page,
        decideOnPaper,
    }) => {
    ...
    test.fixme("When the user presses one of the shortcuts for a decision, then a review is submitted and the next paper to review is opened", async ({
        page,
        decideOnPaper,
    }) => {
        await decideOnPaper.openProjectPaperView(
    ...
    test.fixme("When the user selects certain review criteria and clicks a decision button, then a review is submitted and the decision is shown (because there is no other paper to review).", async ({
        page,
        decideOnPaper,
    }) => {
        await decideOnPaper.openProjectPaperView(
    ...
    test.fixme("When the user opens a project paper in review mode that was already reviewed by the user, then it is not possible to change any decision (including review criteria).", async ({
        page,
        decideOnPaper,
    }) => {
        await decideOnPaper.openProjectPaperView(
